...
Figure 4 - Hydropower Validation
Figure 5 - Annual Hydropower Validation
Figure S4 - Hydropower Validation at individual plants
"""
...
wy_types['WYT'][wy_types.index == 2017] = 'EW' #Adjust for Trinity
wy_types['WYT'][wy_types.index == 2006] = 'EW' #Adjust for Trinity
