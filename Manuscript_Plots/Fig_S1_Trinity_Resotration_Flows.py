...
Figure S1 - Script to plot Trinity Restoration flow based on ROD 2001. 
"""
...
# Read the CSV file
df = pd.read_csv('Manuscript_Plots/data/Trinity_Flow_Schedule.csv') #Location to be changed.
