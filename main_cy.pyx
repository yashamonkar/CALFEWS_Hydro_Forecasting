...
################################################################################################################################
  ...
  cdef int initialize(self) except -1:  
    ...
    if self.model_mode == 'validation':
      ...
      self.flow_input_source = 'CDEC_updated' 
    ...
    expected_release_datafile = 'calfews_src/data/input/cord-sim_realtime.csv'
    ...
    if self.model_mode == 'simulation':
      ...
      base_data_file = 'calfews_src/data/input/cord-sim_realtime.csv'
      ...
      #input_data_file = 'calfews_src/data/input/cord-sim_realtime.csv'
