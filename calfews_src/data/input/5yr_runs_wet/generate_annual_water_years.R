...
#Beginning Storage -- Wet Conditions -- Beginning Oct 1st 2011
...
#Get the dateimte values for the original dataset
datetime_og <- data %>% filter(water_year %in% 2012:(2016))
