...
#Define start data
start_date = pd.Timestamp('2018-10-01')  # Assuming this is the start of your data
...
plt.fill_between(sim_hydro_dry[0]['CVP_Gen'].index, p10_dry, p90_dry, 
                 color='r', alpha=0.3, label='Low Storage Range')
plt.fill_between(sim_hydro_dry[0]['CVP_Gen'].index, p10_wet, p90_wet, 
                 color='b', alpha=0.3, label='High Storage Range')
plt.plot(sim_hydro_dry[0]['CVP_Gen'].index, p50_dry,
         'r-', linewidth=2, alpha=1, linestyle = 'dashdot', label='Low Storage Median') 
plt.plot(sim_hydro_dry[0]['CVP_Gen'].index, p50_wet,
         'b-', linewidth=2, alpha=1, linestyle = 'dashdot', label='High Storage Median') 
