...
Note:- The half the period is used for testing. 
The whole period is used for climatology. 

Predictions for each year. 
1. Storage for that year
2. All the cumulative climatologies added in. Same as the testing case. 
...
for year in range(2004, 2024):
    ...
    p25_sub = all_predictions.groupby(all_predictions.index.month).quantile(0.25)
    ...
    p75_sub = all_predictions.groupby(all_predictions.index.month).quantile(0.75)
...
eia['Predicted'] = exceedances['Predicted']
